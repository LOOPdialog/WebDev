...
import { formDataOnboardingEmailStepAnbieterOfficePage } from '../../../../../helpers/Form/FormData';
...
const EmailStepAnbieterOffice = ({ classes }: { classes: { [key: string]: string } }): React.ReactElement => {
  ...
  const formRenderDataL = useMemo(() => {
    return setRulesForm(formDataOnboardingEmailStepAnbieterOfficePage, {
...
export default EmailStepAnbieterOffice;
